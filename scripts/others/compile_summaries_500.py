...
ROOT = Path("/DATA/vineet/PrivFedTalk/paper_results_500")
...
for variant, p in abl_map.items():
    ...
    row["variant"] = variant
    row["note"] = "Quality-transparent system feature; same metrics as nearest training-equivalent row." if "SecureAgg" in variant else ""
    rows.append(row)
